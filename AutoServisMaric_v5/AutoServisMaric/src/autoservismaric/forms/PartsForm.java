...
import static autoservismaric.forms.HomeForm.numberOfItems;
...
public class PartsForm extends javax.swing.JFrame {
 ...
 setColor(menu6jPanel);
           for(int i=0; i<numberOfItems; i++)
            HomeForm.menu[i]=false;
        HomeForm.menu[4]=true;
        resetColor(menu1jPanel);
        resetColor(menu3jPanel);
        resetColor(menu4jPanel);
        resetColor(menu2jPanel);
        resetColor(menu5jPanel);    }//GEN-LAST:event_menu6jPanelMouseClicked
